...
const allowedWords = [
    'бетон', 'сукња', 'цртач', 'љуска', 'врлет', 'помно', 'много', 'стрмо', 'ризла', 'фењер', 'успут', 'карат', 'тракт', 'мокро', 'хриди', 'њушка', 'црвен', 'седам', 'шљака', 'књига', 'бацач', 'балав', 'пасус', 'врећа', 'листа', 'чежња', 'дрчно', 'сурла', 'гурач', 'оштро', 'речко', 'уклет', 'гудач', 'дрвен', 'супер', 'варош', 'дечко', 'ђубре', 'етажа', 'жарач', 'звоно', 'искра', 'јунак', 'крило', 'лабуд', 'метак', 'накит', 'осмех', 'петак', 'рубин', 'скроб', 'тотем', 'ћумур', 'убрус', 'федер', 'јелен', 'лимун', 'намет', 'плима', 'разум', 'самит', 'тиква', 'успон', 'харфа', 'црнац', 'чопор', 'шебој', 'агава', 'ветар', 'глава', 'дирка', 'ђувеч', 'еклер', 'живот', 'занат', 'исток', 'хотел', 'челик', 'шатор', 'атлас', 'бокал', 'ватра', 'галеб', 'длака', 'ђакон', 'жетон', 'запис', 'исказ', 'кувар', 'левак', 'мозак', 'нотес', 'отпор', 'песак', 'робот', 'авион', 'бајка', 'варка', 'грозд', 'дуван', 'естет', 'жилет', 'икона', 'језик', 'конац', 'Мачка', 'налог', 'опера', 'пилав', 'рукав', 'сапун', 'трава', 'услов', 'фокус', 'јасен', 'корак', 'лутка', 'млеко', 'норма', 'памет', 'мечка', 'сомот', 'тенис', 'ћерка', 'устав', 'фазан', 'химна', 'целер', 'шешир', 'албум', 'бунар', 'гајка', 'насип', 'освит', 'рачва', 'сидро', 'твист', 'ћурка', 'узрок', 'форум', 'харем', 'циста', 'чекрк', 'штука', 'балон', 'вагон', 'грива', 'долар', 'етика', 'закон', 'ирвас', 'храна', 'цимер', 'чизма', 'аванс', 'барел', 'визир', 'гумар', 'екран', 'жакет', 'залив', 'јесен', 'креда', 'ланац', 'молер', 'нотар', 'рабин', 'аспик', 'бурек', 'влада', 'голаћ', 'добош', 'ђерам', 'ексер', 'жипон', 'замор', 'извор', 'јутро', 'киоск', 'лахор', 'мотор', 'најам', 'осица', 'пасош', 'седеф', 'улица', 'јечам', 'калем', 'лабос', 'новац', 'обред', 'ротор', 'флека', 'школа', 'акорд', 'бадем', 'вепар', 'порез', 'радар', 'серум', 'ћуран', 'увала', 'фикус', 'шаран', 'бабун', 'горан', 'душек', 'чесма', 'штета', 'восак', 'гуска', 'даска', 'ишлер', 'колач', 'лотос', 'нокат', 'ормар', 'проба', 'балет', 'екипа', 'лимар', 'нарав', 'обала', 'пуфна', 'стена', 'трема', 'успех', 'јасле', 'котур', 'мрест', 'начин', 'покер', 'ракун', 'сплет', 'тунел', 'ћилим', 'ускок', 'фарма', 'цимет', 'читач', 'барка', 'назив', 'олово', 'потез', 'ребус', 'сутон', 'трака', 'фетус', 'хајка', 'благо', 'време', 'глума', 'длето', 'зубун', 'цекин', 'човек', 'донор', 'епоха', 'зебра', 'ивица', 'кечап', 'ликра', 'отказ', 'пораз', 'радио', 'брада', 'врата', 'жамор', 'злато', 'јарак', 'капут', 'мајка', 'оклоп', 'ручак', 'силос', 'точак', 'гусан', 'дамар', 'завет', 'избор', 'Козак', 'лишај', 'месец', 'оглас', 'просо', 'рекет', 'сонет', 'торба', 'цигла', 'четка', 'излет', 'ковач', 'ласер', 'месар', 'нитна', 'облак', 'пилот', 'секта', 'ћуфте', 'упала', 'чокот', 'шевар', 'акита', 'барут', 'расол', 'склад', 'тенор', 'флота', 'цуцла', 'череп', 'шодер', 'брука', 'грађа', 'динар', 'зурла', 'калуп', 'ласта', 'хумус', 'црква', 'шумар', 'брест', 'волан', 'гргеч', 'дабар', 'жабац', 'канта', 'лента', 'мурва', 'нерад', 'евнух', 'зидар', 'мотел', 'отпад', 'перон', 'ролат', 'слово', 'табор', 'ћитаб', 'факин', 'зубар', 'исход', 'мачак', 'невен', 'рогач', 'сусам', 'тифус', 'фрула', 'шнала', 'врана', 'ратар', 'сомун', 'тапир', 'фишек', 'чорак', 'севар', 'арена', 'велур', 'галоп', 'долап', 'змија', 'излог', 'јарам', 'кедар', 'лепак', 'бреза', 'гепек', 'јакна', 'крава', 'мамут', 'напон', 'орбит', 'грана', 'дечак', 'жезло', 'залог', 'јелек', 'лопта', 'орден', 'полип', 'тацна', 'чекић', 'јадро', 'кловн', 'лемур', 'неред', 'пекар', 'рикша', 'труба', 'цуран', 'факат', 'чигра', 'аутор', 'пелат', 'рерна', 'скала', 'чунак', 'астал', 'батак', 'вазал', 'греда', 'јавор', 'круна', 'драго', 'лажно', 'болно', 'бушно', 'цитра', 'чавка', 'бизон', 'вергл', 'датив', 'ждрал', 'зарез', 'имела', 'лупус', 'оркан', 'јунац', 'краба', 'напад', 'оникс', 'замка', 'идиом', 'корен', 'осека', 'талог', 'усхит', 'факир', 'химен', 'цваст', 'анфас', 'брлог', 'удица', 'цирка', 'базен', 'бонус', 'жубор', 'капак', 'лишће', 'палма', 'чабар', 'шамот', 'еснаф', 'жетва', 'кајак', 'лотра', 'мицна', 'опека', 'пушка', 'рафал', 'салса', 'замах', 'коала', 'мисао', 'несит', 'тачка', 'фарба', 'хрчак', 'цегер', 'черга', 'лопов', 'маска', 'рокер', 'сунце', 'трска', 'фагот', 'штака', 'брава', 'текст', 'белег', 'голуб', 'жаока', 'идеја', 'носач', 'ловац', 'орган', 'поема', 'жвака', 'купус', 'модро', 'писац', 'ризом', 'сатир', 'фазон', 'шапка', 'копач', 'писмо', 'копар', 'ручка', 'сатен', 'транс', 'фотка', 'црнка', 'апоен', 'викар', 'фалта', 'цртеж', 'чакра', 'дошао', 'шакал', 'ајвар', 'домар', 'испит', 'кибиц', 'мелем', 'бедем', 'петао', 'роман', 'зенит', 'јарац', 'неман', 'ровац', 'траса', 'учкур', 'црево', 'амеба', 'канал', 'летак', 'олуја', 'тимар', 'храст', 'шивач', 'акреп', 'гавез', 'драма', 'цитат', 'шерпа', 'галон', 'дебло', 'елита', 'ингот', 'јацеа', 'колут', 'народ', 'блуза', 'кофер', 'модел', 'надев', 'рулет', 'затон', 'летва', 'метла', 'опело', 'салаш', 'топот', 'утрка', 'фарса', 'арома', 'лидер', 'орман', 'сокак', 'ћитап', 'уштап', 'фијук', 'хидра', 'датум', 'савет', 'чорба', 'штала', 'бомба', 'глина', 'дрозд', 'жохар', 'јатак', 'црвић', 'вашар', 'гозба', 'згода', 'јелка', 'кубик', 'марка', 'потоп', 'рампа', 'еркер', 'лавор', 'рутер', 'север', 'шунка', 'кумин', 'пласт', 'слава', 'талас', 'украс', 'цепин', 'чобан', 'видра', 'собар', 'чилаш', 'вивак', 'јерес', 'карта', 'лонац', 'мрежа', 'чичак', 'шерет', 'буква', 'метал', 'октет', 'пакет', 'кулен', 'отпис', 'рибар', 'тикет', 'ћевап', 'футур', 'шарка', 'кутак', 'порок', 'табла', 'влага', 'слика', 'терет', 'аорта', 'журка', 'индус', 'шипка', 'весло', 'гулаш', 'дулек', 'јадац', 'мопед', 'посао', 'радно', 'замак', 'малер', 'отров', 'патка', 'углед', 'чудак', 'џезва', 'манир', 'оквир', 'право', 'фелер', 'шећер', 'визон', 'илеус', 'лосос', 'метар', 'хокеј', 'чипка', 'вихор', 'жижак', 'клада', 'едикт', 'образ', 'тигар', 'циник', 'конак', 'нагон', 'танго', 'шофер', 'фосил', 'цеста', 'вазна', 'декор', 'живац', 'логор', 'морон', 'шибер', 'басна', 'откос', 'понос', 'идиот', 'одрон', 'стент', 'труст', 'улога', 'измет', 'масон', 'орион', 'палац', 'рудар', 'висак', 'форма', 'хорда', 'штека', 'битка', 'вашка', 'зајам', 'кефир', 'чамац', 'антре', 'женка', 'лутак', 'момак', 'олтар', 'попис', 'запад', 'клима', 'модем', 'плата', 'рачун', 'сукоб', 'џокер', 'домен', 'тегла', 'штрас', 'етида', 'цифра', 'завод', 'ђуска', 'зумба', 'орада', 'песма', 'локал', 'ранац', 'степа', 'тезга', 'алеја', 'бутик', 'бакар', 'еспап', 'шамар', 'бохор', 'товар', 'чемер', 'навод', 'тепих', 'стока', 'гусле', 'догма', 'ензим', 'корпа', 'алиби', 'винил', 'ебола', 'манго', 'емајл', 'мамац', 'омлет', 'полет', 'тонус', 'редов', 'сепет', 'табан', 'мохер', 'шајка', 'април', 'гекон', 'дорат', 'ибрик', 'литар', 'ореол', 'паста', 'родео', 'кокос', 'панел', 'сируп', 'ћуфта', 'ислам', 'крема', 'рецка', 'титан', 'поток', 'чувар', 'гесло', 'фешта', 'цекер', 'валов', 'говор', 'округ', 'лагер', 'магла', 'напор', 'окрет', 'слама', 'камен', 'ларва', 'папир', 'рабат', 'темпо', 'веста', 'плоча', 'тромб', 'видик', 'жалба', 'анђео', 'лажов', 'метро', 'облик', 'класа', 'цивил', 'извоз', 'склоп', 'утеха', 'божур', 'терен', 'уздах', 'газда', 'ловор', 'ампер', 'нанос', 'срећа', 'клупа', 'софра', 'тајга', 'вокал', 'рестл', 'много', 'многи', 'ћорак', 'гумно', 'колос', 'шутер', 'канап', 'пошта', 'сетер', 'уплив', 'одмор', 'ћумез', 'аргон', 'букет', 'кугла', 'бреме', 'дирек', 'опрез', 'поноћ', 'снага', 'фраза', 'мотив', 'регал', 'тутор', 'печат', 'сајам', 'лежај', 'доказ', 'етапа', 'салдо', 'резус', 'брига', 'вијак', 'геном', 'дубак', 'веган', 'одаја', 'олива', 'сачма', 'потаж', 'синус', 'узвик', 'херој', 'возач', 'рагби', 'ускрс', 'цокла', 'амбис', 'блато', 'глоба', 'утока', 'черек', 'гелер', 'коров', 'самар', 'ћошак', 'хорор', 'сафир', 'таван', 'врста', 'створ', 'алгин', 'бехар', 'афера', 'мерак', 'обруч', 'рапир', 'махер', 'ревер', 'сарач', 'торта', 'бурад', 'вајар', 'бегеш', 'гајде', 'епика', 'кувас', 'бивак', 'јавка', 'мидер', 'гушче', 'расад', 'салон', 'херба', 'црева', 'санта', 'ћириш', 'фиока', 'вижла', 'залет', 'банда', 'домет', 'хамам', 'јереј', 'лелек', 'врсан', 'ритер', 'пазух', 'гибак', 'бодеж', 'витез', 'играч', 'немар', 'пакао', 'хобит', 'износ', 'кобац', 'мирис', 'пајац', 'хумор', 'ископ', 'камин', 'лекар', 'будак', 'дугме', 'клише', 'мазут', 'сифон', 'фирма', 'окука', 'хунта', 'дебил', 'кобра', 'занос', 'пупак', 'бирач', 'парип', 'стопа', 'брана', 'гатер', 'досег', 'арија', 'зомби', 'ликер', 'метеж', 'проја', 'спорт', 'фетиш', 'трзај', 'волеј', 'актер', 'власт', 'фрапе', 'наука', 'оглед', 'тоцак', 'фотон', 'башта', 'купон', 'демон', 'лујка', 'повез', 'тучак', 'шипак', 'асура', 'глето', 'кулов', 'масло', 'накот', 'резач', 'тукан', 'ћурак', 'шогор', 'немир', 'лакат', 'музеј', 'топуз', 'један', 'чиков', 'губав', 'лимит', 'бисер', 'десет', 'колац', 'машта', 'ривал', 'тетка', 'флаша', 'птица', 'узлет', 'граја', 'квака', 'одећа', 'тајна', 'гареж', 'држач', 'амбар', 'дудук', 'обест', 'полен', 'сарма', 'ребро', 'течај', 'ризик', 'сајла', 'чоков', 'дрмеш', 'закоп', 'злоба', 'нугат', 'ресор', 'номад', 'шанац', 'савез', 'харач', 'еолит', 'даире', 'заова', 'лагум', 'полка', 'спруд', 'чарда', 'шаман', 'вишак', 'шанса', 'декан', 'жмара', 'коска', 'водка', 'казна', 'лицеј', 'пудер', 'зубор', 'завој', 'лебац', 'мачор', 'пешак', 'тинта', 'бећар', 'девер', 'певач', 'ћивот', 'шаров', 'винар', 'јецај', 'дувар', 'машна', 'ташна', 'задах', 'оскар', 'плева', 'пушач', 'гусак', 'чупав', 'испад', 'метан', 'тајац', 'крчаг', 'позив', 'лисје', 'булка', 'женик', 'пацов', 'рођак', 'ћетен', 'режим', 'хвала', 'дашак', 'зилот', 'казан', 'пасив', 'гусар', 'зелот', 'стрип', 'тесар', 'виски', 'снаја', 'ћутук', 'јаран', 'шапат', 'гирос', 'калфа', 'сетва', 'тарот', 'бедро', 'терор', 'полог', 'цајгл', 'шарац', 'жупан', 'воћар', 'ролка', 'унија', 'бечар', 'комад', 'ендем', 'минер', 'ирада', 'јагње', 'узгон', 'навој', 'салва', 'унука', 'фреза', 'ништа', 'багра', 'атест', 'једро', 'гроза', 'колар', 'тумач', 'чајка', 'шојка', 'рабош', 'удаја', 'анекс', 'такси', 'легло', 'нацрт', 'хусар', 'идила', 'седло', 'аласи', 'бибер', 'кафић', 'нишан', 'рарог', 'група', 'дизна', 'брзак', 'дрека', 'зипон', 'барон', 'векна', 'пумпа', 'спрат', 'тапет', 'хауба', 'алкар', 'гужва', 'дукат', 'сенка', 'жбука', 'лампа', 'мотка', 'ортак', 'пехар', 'лудак', 'омица', 'сквер', 'зетон', 'нудус', 'ситар', 'воћка', 'сабор', 'јамац', 'цокна', 'шетач', 'мазга', 'рогоз', 'корал', 'кадет', 'чибук', 'шериф', 'хорна', 'колан', 'масер', 'осврт', 'ритам', 'талон', 'чочек', 'багер', 'везир', 'гулаг', 'лапот', 'узгој', 'прича', 'смена', 'гајба', 'шурак', 'логос', 'страх', 'дућан', 'пожар', 'одред', 'томос', 'борба', 'пелин', 'црпка', 'излаз', 'котао', 'коцка', 'фарад', 'клема', 'ретуш', 'халва', 'врело', 'пелир', 'лисац', 'патак', 'судар', 'уштва', 'чарка', 'анкер', 'место', 'опран', 'пегла', 'кепец', 'хумка', 'чечен', 'дршка', 'цијук', 'јагма', 'намаз', 'јахта', 'пруга', 'стрес', 'ренде', 'цилик', 'бурма', 'данак', 'забит', 'путар', 'пегаз', 'редар', 'чиода', 'аскер', 'шкарт', 'пород', 'урнек', 'зулум', 'шегрт', 'моном', 'салто', 'шахта', 'шараф', 'купац', 'андол', 'кости', 'кадар', 'кулак', 'поруб', 'сласт', 'цурка', 'хамер', 'цубок', 'гауда', 'дезен', 'елиса', 'царић', 'добос', 'зигот', 'писта', 'дозна', 'назеб', 'истек', 'огрев', 'сукно', 'узица', 'атоми', 'спуст', 'алмум', 'каста', 'багет', 'етнос', 'поука', 'дупин', 'деран', 'берза', 'дурум', 'пазар', 'суфле', 'морал', 'пенал', 'репер', 'венац', 'дрска', 'жртва', 'самац', 'панда', 'бокор', 'ухода', 'пркос', 'лопар', 'талац', 'јахач', 'лавеж', 'јидиш', 'анода', 'бунда', 'валер', 'аерат', 'друид', 'бачва', 'пепео', 'аларм', 'мурал', 'добар', 'обзир', 'арсен', 'канон', 'испис', 'ремен', 'голет', 'амаро', 'ђулса', 'кусур', 'свест', 'цекиц', 'бараж', 'иступ', 'проза', 'сквош', 'оброк', 'обрва', 'плашт', 'зазор', 'колаж', 'облог', 'резон', 'сплав', 'шубер', 'ослић', 'базар', 'ствар', 'карма', 'прело', 'стадо', 'сенат', 'варан', 'забат', 'касир', 'каћун', 'никел', 'пират', 'флерт', 'барок', 'крчма', 'калај', 'откуп', 'девет', 'додир', 'добит', 'одмах', 'мираз', 'океан', 'склек', 'мином', 'аскет', 'минут', 'кекец', 'редут', 'шпајз', 'гарда', 'јетра', 'јуфка', 'акрил', 'жагор', 'врпца', 'тумор', 'мошус', 'одјек', 'одело', 'убица', 'флора', 'мућак', 'веспа', 'ногар', 'патос', 'утаја', 'свила', 'набоб', 'толар', 'гонич', 'помоћ', 'свећа', 'табак', 'сатор', 'борац', 'ходач', 'морка', 'струк', 'флуид', 'понор', 'питон', 'јемац', 'сирће', 'умеће', 'ратно', 'дојка', 'журба', 'зачин', 'сленг', 'мехур', 'сорта', 'одора', 'прота', 'нагиб', 'хакер', 'тисак', 'имбус', 'даске', 'цвеће', 'осама', 'лигаш', 'певац', 'падеж', 'јуриш', 'отвор', 'виола', 'особа', 'ћубан', 'сеник', 'довод', 'алоја', 'лапис', 'трола', 'ћушка', 'часак', 'насад', 'топаз', 'кавез', 'бивол', 'гинко', 'гениј', 'мерач', 'идеал', 'ефект', 'жилав', 'зефир', 'копча', 'акшам', 'зозон', 'прасе', 'лугар', 'одзив', 'релеј', 'ларма', 'косач', 'аверс', 'хитац', 'дилер', 'могул', 'лакеј', 'слајс', 'ципов', 'ђогат', 'набор', 'перец', 'кедер', 'ретро', 'кинта', 'папак', 'типка', 'пацер', 'рижот', 'парче', 'ћувик', 'тонер', 'чилим', 'бутан', 'порив', 'којот', 'рачве', 'банка', 'набој', 'дођош', 'ташта', 'џихад', 'епарх', 'тегет', 'излив', 'наћве', 'ропот', 'повод', 'ложач', 'бином', 'мишић', 'цезар', 'тираж', 'ролна', 'лонче', 'нобел', 'однос', 'погон', 'биста', 'нимфа', 'сусед', 'шифра', 'егзил', 'јелеј', 'капар', 'бидон', 'путер', 'скела', 'цвета', 'извод', 'такса', 'кабал', 'болид', 'цевка', 'чалма', 'швепс', 'куран', 'ћесам', 'слога', 'давеж', 'сокол', 'лузер', 'сухој', 'немац', 'купка', 'обука', 'молба', 'тркач', 'крађа', 'наћос', 'штене', 'лепра', 'зелен', 'марва', 'немоћ', 'церка', 'унуче', 'нећак', 'астма', 'атика', 'зулуф', 'кебаб', 'отава', 'зидан', 'нафта', 'матор', 'кулук', 'стаза', 'торзо', 'изрод', 'вапор', 'омега', 'писар', 'слуга', 'врбак', 'локва', 'сирак', 'чедар', 'зрака', 'монах', 'пређа', 'кифла', 'левча', 'хипик', 'посед', 'инокс', 'памук', 'одраз', 'аграр', 'синод', 'сокна', 'терма', 'урлик', 'натег', 'одвод', 'преса', 'рента', 'сутра', 'уцена', 'загор', 'диода', 'зицер', 'фосна', 'бусен', 'видео', 'одбор', 'талир', 'крамп', 'груда', 'менза', 'покус', 'појас', 'курир', 'чудно', 'локна', 'кинез'
]
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    const newGame = function(endGame) {
        ...
        if (endGame) {
            score = 0;
            const rewardIcons = gameRewardWrapper.querySelectorAll('.game-reward__item');
        ...
        if (isWordAllowed) {
            ...
            inputFields.forEach((input, index) => {
                ...
                if (letterPosition === -1) {
                    ...
                    if (userChar === correctWord[index]) {
                        ...
                        if (Array.from(correctWord).includes(userChar) && !usedLetters.includes(userChar)) {
            ...
            if(Number(localStorage.getItem('tries')) <= 5) {
                ...
                if (userWord === correctWord) {
                    ...
                    setTimeout(() => {
                        const modalLost = new Modal({ content: modalLooseHTML });
                        setTimeout(() => {
                            modalLost.open();
                            newGame(true);
                        }, 300);
            ...
            if (activeCharacterInputIndex) {
                switch (buttonLetter) {
                    ...
                    case 'backspace':
                            ...
                            activeElement.dispatchEvent(new KeyboardEvent("keydown", { key: "Backspace", 'code': "Backspace",}));
        ...
        constructor({ content = '', closeButton = true } = {}) {
            ...
            this.modal.innerHTML = `
                ...
                <div class="modal-content">
                    ${closeButton ? '<button class="modal-close">&times;</button>' : ''}
