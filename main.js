    ...
    */
    ...
    submitButton.addEventListener('click', (e) => {
        ...
        if (isWordAllowed) {
            ...
            increaseTries();
            console.log('try number: ', Number(localStorage.getItem('tries')));
